    ...
    <div class="modal fade" tabindex="-1" id="myModal">
        <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.settings.job-titles.store') }}" id="submitForm" method="post">
                    @csrf
            ...
            let myTable = $('#myTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'name', name: 'name'},
                    {
                        ...
                        render: function (data, type, row) {
                            return `<span class="badge badge-light-${data ? 'success' : 'danger'}">${data ? 'Active' : 'Inactive'}</span>`;
                        }
                    },
